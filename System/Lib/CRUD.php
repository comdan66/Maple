...
abstract class CRUD {
  ...
  public function setBackUrl($href, $text = '回列表') {
    $this->back = \HTML\A::create($text)->href(CRUD::getBackOffsetLimit($href));
    return $this;
  }
...
spl_autoload_register(function($className) {
  ...
  Load::systemLib(($namespace ? implode(DIRECTORY_SEPARATOR, $namespace) . DIRECTORY_SEPARATOR : '') . deNamespace($className));
