...
Router::dir('admin', 'Admin', function() {
  ...
  // AdminAjaxError
  Router::get('ajaxError')->controller('AdminAjaxError@index');
  Router::post('ajaxError')->controller('Main@ajaxErrorCreate');
  Router::get('ajaxError/(id:id)')->controller('AdminAjaxError@show');
  Router::post('ajaxError/(id:id)/read')->controller('AdminAjaxError@read');
});