...
class Table extends \CRUD {
  ...
  public function list($closure) {
    ...
    //   $this->tableStr .= $this->sortLink ? '<table class="list dragable" data-sorturl="' . $this->sortLink . '">' : '<table class="list">';
    ...
    //         return ($this->sortLink && $tds[0]->getObj() && isset($tds[0]->getObj()->id, $tds[0]->getObj()->sort) ? '<tr data-id="' . $tds[0]->getObj()->id . '" data-sort="' . $tds[0]->getObj()->sort . '">' : '<tr>') . implode('', $tds) . '</tr>';
    ...
    // $this->tableStr .= $title ? '<span class="crud-title">' . $title . '</span>' : '';
