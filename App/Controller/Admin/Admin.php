...
class Admin extends AdminController {
  ...
  public function create() {
    ...
    $params = Validator::post(function() {
      Validator::need('name', '名稱')->isString(1, 190);
      Validator::need('account', '帳號')->isString(1, 190);
      Validator::need('password', '密碼')->isString(1, 190);
      Validator::maybe('roles', '角色')->default([])->filter(array_keys(\M\AdminRole::ROLE));
    });

    $files = Validator::file(function() {
      Validator::maybe('avatar', '頭像')->default(null)->isUpload()->formatFilter(['jpg', 'png', 'jpeg']);
    });
